...
file_paths=['/home/ruben/M2-Stage-Liphy/test_colonne_sans_mousse_vidange_8_co2.csv',
           '/home/ruben/M2-Stage-Liphy/Test_eau_pure/test_colonne_3D_eau_pure_vidange_8_co2.csv' ,
            '/home/ruben/M2-Stage-Liphy/vidange_600ml_eau_pur_mi_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/Tests_colonne_mousse_3D/test_colonne_mousse_3D_160424_70cmc_vidange_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/vidange_mousse_70CMC_600ml_plus_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/vidange_300ml_5gL_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/vidange_600ml_cinqgramesparlittre_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/vidange_aspiro_300ml_3point5_8_co2.csv',
            '/home/ruben/M2-Stage-Liphy/vidange_CO2_600ml_aspiro_035gparL.csv'
            ]
...
for file_path in file_paths:
    ...
    #plt.plot(x, func(x, *popt), label=f'fit {label}: a={popt[0]:.5f}, b={popt[1]:.5f}')
